...
export const InteractiveGradient = ({ color = "#1890ff", glowColor = "#107667ed", width = "", height = "", borderRadius = "2.25rem", className = "", children, followMouse = true, hoverOnly = false, intensity = 100, backgroundColor = "#000" }) => {
    ...
    return (_jsxs("div", { ref: cardRef, className: cn(`relative grid place-content-center place-items-center
         text-center shadow-[1px_12px_25px_rgba(0,_0,_0,_0.78)] 
         transition-all duration-300 interactive-gradient-card`, className), style: {
            ...getBackgroundStyle(),
            ...getBorderStyle(),
            width,
            height,
