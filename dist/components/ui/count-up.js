...
export function CountUp({ value, duration = 2, decimals = 0, prefix = "", suffix = "", easing = "easeOut", separator = ",", interactive = false, triggerOnView = true, className, numberClassName, animationStyle = "default", colorScheme = "default", customColor, onAnimationComplete, }) {
    ...
    return (_jsx("div", { ref: containerRef, className: cn("inline-flex items-center justify-center text-4xl font-bold", className), children: _jsxs(motion.div, { ...getHoverAnimation(), className: cn("flex items-center transition-all", colorClass, numberClassName), style: colorScheme === "custom" && customColor ? { color: customColor } : undefined, children: [prefix && _jsx("span", { className: "mr-1", children: prefix }), _jsx(motion.span, { children: rounded }), suffix && _jsx("span", { className: "ml-1", children: suffix })] }) }));
}
