...
const AccordionItem = React.forwardRef(({ className, value, disabled = false, children, ...props }, ref) => {
    return (_jsx(AccordionItemContext.Provider, { value: { value }, children: _jsx("div", { ref: ref, className: cn("border-b", className), "data-state": disabled ? "disabled" : undefined, "data-value": value, ...props, children: children }) }));
});
...
const AccordionTrigger = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (_jsxs("button", { ref: ref, type: "button", className: cn("flex flex-1 items-center justify-between py-4 font-medium transition-all hover:underline [&[data-state=open]>svg]:rotate-180", className), onClick: handleToggle, "data-state": isOpen ? "open" : "closed", ...props, children: [children, _jsx(ChevronDown, { className: "h-4 w-4 shrink-0 transition-transform duration-200" })] }));
});
