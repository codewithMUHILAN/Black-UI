  ...
  return (
    <div 
      ...
      className={cn("relative min-h-screen w-full overflow-hidden", 
                    darkMode ? "bg-zinc-900 text-zinc-100" : "", 
                    className)}
    >
      {/* Header section */}
      ...
      <div className="relative max-w-6xl mx-auto px-4 pb-24">
        ...
        <div className="relative mx-auto">
          ...
          {progressIndicator && (
            <motion.div
              className={cn(
                "absolute top-0 w-1 rounded-t-full", 
                activeColor
              )}
              style={{ 
            ...
            {events.map((event, index) => {
              ...
              return (
                <div 
                  ...
                  className={cn(
                    "relative flex flex-col lg:flex-row items-center mb-20 py-4",
                    cardAlignment === "alternating" ? 
                      (index % 2 === 0 ? "lg:justify-end" : "lg:justify-start") :
                      cardAlignment === "left" ? "lg:justify-start" : "lg:justify-end"
                  )}
                >
                  {/* Center dot */}
                  <div className="absolute left-1/2 top-0 transform -translate-x-1/2 z-10">
                    <div className={cn(
                      ...
                      index <= activeIndex ? "border-primary bg-background" : "border-border bg-card",
                    )}></div>
                  </div>
