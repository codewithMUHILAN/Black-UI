...
function DockItem({
  ...
  return (
    <motion.div
      ...
      bg-background border-2 border-neutral-700 shadow-md  "
      tabIndex={0}
      role="button"
      aria-haspopup="true"
    >
      ...
      <AnimatePresence>
        {showLabel && (
          <motion.div
            ...
            border border-neutral-700 bg-[#060606] px-2 py-0.5 text-xs text-white"
            style={{ x: "-50%" }}
            role="tooltip"
          >
            {label}
    ...
    >
      <motion.div
        ...
        className={`absolute bottom-2 left-1/2 -translate-x-1/2 transform 
            ...
            border-2 border-neutral-700 px-4 pb-2 ${className}`}
