  ...
  ({ 
    ...
    return (
      ...
      >
        ...
        {dismissible && (
          <button
            className="absolute top-4 right-4 rounded-full p-1 text-foreground/70 opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
